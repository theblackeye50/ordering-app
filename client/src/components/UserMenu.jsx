...
const UserMenu = ({close}) => {
   ...
   const handleLogout = async()=>{
        try {
          ...
          // Call the logout API
          // If the API returns success, then clear the local storage and dispatch logout action    
          // If the API returns error, then show the error message
          // If the API returns success, then show the success message and navigate to home page 
